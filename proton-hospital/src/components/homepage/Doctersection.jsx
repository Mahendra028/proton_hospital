...
//   return (
//     <section className="relative px-4 py-16 overflow-hidden md:px-8 bg-gradient-to-b from-gray-50 to-white">
//       {/* Simplified Background Elements */}
//       <div className="absolute w-64 h-64 rounded-full top-10 left-10 bg-blue-50 mix-blend-multiply filter blur-3xl opacity-20"></div>
//       <div className="absolute w-64 h-64 rounded-full bottom-10 right-10 bg-indigo-50 mix-blend-multiply filter blur-3xl opacity-20"></div>
...
//         >
//           <motion.span 
//             className="inline-block px-4 py-2 mb-4 text-sm font-semibold text-white rounded-full shadow-md bg-gradient-to-r from-blue-500 to-indigo-500"
//             initial={{ scale: 0 }}
//             animate={{ scale: 1 }}
...
//               <motion.div
//                 className="absolute z-40 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
//                 animate={{ 
//                   scale: showDoctors ? 1.05 : 1,
//                 }}
//                 transition={{ duration: 0.3 }}
//               >
//                 <div className="relative w-64 h-64 overflow-hidden border-8 border-white rounded-full shadow-2xl bg-gradient-to-br from-blue-50 to-indigo-50">
//                   <img
//                     src={centerImage}
...
//                 <motion.div 
//                   className="absolute px-5 py-3 text-white transform -translate-x-1/2 rounded-lg shadow-lg -bottom-6 left-1/2 bg-gradient-to-r from-blue-500 to-indigo-500"
//                   initial={{ opacity: 0, y: 10 }}
//                   animate={{ opacity: 1, y: 0 }}
//                   transition={{ delay: 0.5 }}
//                 >
//                   <span className="text-sm font-bold">MEDICAL HUB</span>
//                 </motion.div>
//               </motion.div>
...
//                           <div className="mx-auto overflow-hidden border-white rounded-full shadow-md w-14 h-14 border-3">
//                             <img
//                               src={doctor.img}
//                               alt={doctor.name}
//                               className="object-cover w-full h-full"
//                             />
//                           </div>
//                           <div className="absolute flex items-center justify-center w-6 h-6 rounded-full shadow-sm -top-1 -right-1 bg-gradient-to-r from-blue-500 to-indigo-500">
...
//               {showDoctors && (
//                 <motion.div
//                   className="absolute inset-0 m-20 border-2 rounded-full border-blue-100/30"
...
//         {isDesktop && (
//           <motion.div 
//             className="grid max-w-5xl grid-cols-1 gap-6 mx-auto md:grid-cols-2 lg:grid-cols-3"
//             initial={{ opacity: 0, y: 20 }}
//             animate={{ opacity: 1, y: 0 }}
//             transition={{ duration: 0.6 }}
//           >
...
//               >
//                 {/* Doctor Image */}
//                 <div className="relative flex-shrink-0 inline-block mb-4">
//                   <div className="absolute flex items-center justify-center w-8 h-8 rounded-full shadow-md -top-2 -right-2 bg-gradient-to-r from-blue-500 to-indigo-500">
//                     <span className="text-xs font-bold text-white">{index + 1}</span>
//                   </div>
//                   <div className="w-20 h-20 overflow-hidden border-4 border-white rounded-full shadow-md">
//                     <img
//                       src={doctor.img}
//                       alt={doctor.name}
//                       className="object-cover w-full h-full"
...
//                   <div className="mb-3">
//                     <h3 className="mb-2 text-lg font-bold text-gray-900 truncate">
//                       {doctor.name}
//                     </h3>
...
//                   {/* Action Button */}
//                   <motion.button
//                     className="w-full py-2 mt-auto font-medium text-white transition-all duration-300 rounded-lg shadow-sm bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600"
//                     whileTap={{ scale: 0.97 }}
//                   >
//                     View Profile
//                   </motion.button>
...
//               {/* Flip Card */}
//               <motion.div
//                 className="relative overflow-hidden bg-white shadow-2xl rounded-xl"
//                 animate={{ 
...
//                   <motion.button
//                     className="absolute z-10 flex items-center justify-center w-8 h-8 transition-colors bg-gray-100 rounded-full top-4 right-4 hover:bg-gray-200"
...
//                     <div className="w-24 h-24 mx-auto overflow-hidden border-4 border-white rounded-full shadow-lg">
//                       <img
...
//                       <div className="mb-1 text-xs text-gray-500">Specialization</div>
//                       <div className="text-sm font-semibold">{selectedDoctor.role}</div>
//                     </div>
//                     <div className="p-3 rounded-lg bg-gray-50">
//                       <div className="mb-1 text-xs text-gray-500">Achievement</div>
//                       <div className="text-sm font-semibold">{selectedDoctor.awards}</div>
//                     </div>
//                   </div>
...
//                     </motion.button>
//                     <motion.button
//                       className="flex-1 py-3 font-semibold text-gray-700 transition-all duration-300 bg-gray-100 border border-gray-200 rounded-lg hover:bg-gray-200"
//                       whileHover={{ scale: 1.02 }}
//                       whileTap={{ scale: 0.98 }}
//                       onClick={handleCloseModal}
//                     >
...
const doctors = [
  {
    ...
    bio: "15+ years ICU experience, specialized in multi-organ failure management",
    details:
      "Dr. Kumar leads our ICU department with expertise in critical care protocols.",
    experience: "15 Years",
    awards: "Best Critical Care Specialist 2022",
    color: "from-blue-500 to-cyan-500",
  },
  {
    ...
    img: patel,
    bio: "Expert in cardiac emergencies and trauma surgery",
    details: "Dr. Patel has reduced ER wait times by 40%.",
    experience: "12 Years",
    awards: "Emergency Excellence Award 2023",
    color: "from-emerald-500 to-teal-500",
  },
  {
    ...
    img: mehta,
    bio: "20+ years in cardiac intensive care and post-op recovery",
    details: "Dr. Mehta pioneered minimally invasive cardiac procedures.",
    experience: "20 Years",
    awards: "Cardiac Care Pioneer 2021",
    color: "from-rose-500 to-pink-500",
  },
  {
    ...
    img: doctor1,
    bio: "Expert in stroke management and neurological disorders",
    details: "Leads our stroke unit with advanced neuroimaging.",
    experience: "14 Years",
    awards: "Neurology Innovation Award",
    color: "from-purple-500 to-violet-500",
  },
  {
    ...
    img: doctor2,
    bio: "Specialized in pediatric critical care and neonatal medicine",
    details: "Treated over 5000 pediatric patients.",
    experience: "11 Years",
    awards: "Pediatric Care Excellence",
    color: "from-amber-500 to-orange-500",
  },
  {
    ...
    role: "Surgical ICU Lead",
    img: doctor3,
    bio: "Post-surgical care and complex recovery expert",
    details: "Implemented enhanced recovery protocols.",
    experience: "18 Years",
    awards: "Surgical Care Leadership",
    color: "from-indigo-500 to-blue-500",
  },
...
export default function DoctorSection() {
  ...
  const handleCardClick = (doctor) => {
    setSelectedDoctor(doctor);
    setFlipState((prev) => ({ ...prev, [doctor.id]: true }));
  };
  ...
  return (
    <section className="relative px-4 py-16 overflow-hidden md:px-8 bg-gradient-to-b from-gray-50 to-white">
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        {!isDesktop && (
          <div
            className="relative flex items-center justify-center min-h-[700px] mb-20"
            onMouseEnter={() => setShowDoctors(true)}
            onMouseLeave={() => setShowDoctors(false)}
          >
            <div className="relative w-[700px] h-[700px]">
              ...
              <motion.div
                className="absolute z-40 transform -translate-x-1/2 -translate-y-1/2 top-1/2 left-1/2"
                animate={{ scale: showDoctors ? 1.05 : 1 }}
                transition={{ duration: 0.3 }}
              >
                {/* ✅ RESPONSIVE FIX (ONLY CHANGE) */}
                <div className="relative w-20 h-20 overflow-hidden border-4 border-white rounded-full shadow-2xl sm:w-24 sm:h-24 lg:w-64 lg:h-64 lg:border-8 bg-gradient-to-br from-blue-50 to-indigo-50">
                  <img
                    src={centerImage}
                    alt="Medical Excellence Hub"
                    className="object-cover w-full h-full"
              ...
              <AnimatePresence>
                {showDoctors &&
                  doctors.map((doctor, index) => {
                    const angle =
                      (index * (360 / doctors.length)) * (Math.PI / 180);
                    const radius = 280;
                    const x = 350 + Math.cos(angle) * radius - 120;
                    const y = 350 + Math.sin(angle) * radius - 112.5;

                    return (
                      <motion.div
                        key={doctor.id}
                        className="absolute w-60 h-[225px] bg-white rounded-xl shadow-lg p-4 text-center cursor-pointer border z-30"
                        style={{ left: x, top: y }}
                        ...
                        onClick={() => handleCardClick(doctor)}
                      >
                        <div className="mx-auto mb-3 overflow-hidden border-2 rounded-full w-14 h-14">
                          <img
                            src={doctor.img}
                            alt={doctor.name}
                            className="object-cover w-full h-full"
        ...
        {isDesktop && (
          <div className="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
            {doctors.map((doctor) => (
              <div
                key={doctor.id}
                className="p-5 text-center bg-white shadow-lg rounded-xl"
                onClick={() => handleCardClick(doctor)}
              >
                <div className="w-20 h-20 mx-auto mb-4 overflow-hidden border-4 rounded-full">
                  <img
                    src={doctor.img}
                    alt={doctor.name}
                    className="object-cover w-full h-full"
      ...
      <AnimatePresence>
        {selectedDoctor && (
          ...
          >
            <motion.div
              className="p-6 bg-white shadow-2xl rounded-xl"
              onClick={(e) => e.stopPropagation()}
            >
              <h3 className="text-xl font-bold">{selectedDoctor.name}</h3>
              <p className="text-gray-600">{selectedDoctor.details}</p>
            </motion.div>
          </motion.div>
        )}
      </AnimatePresence>
