...
//   return (
//     <section className="bg-[#f6f8fb] py-28 overflow-hidden">
//       <motion.div
...
//         {/* HEADING */}
//         <motion.h2
//           className="mb-4 text-4xl font-semibold text-center text-gray-900"
...
//         <motion.p
//           className="max-w-xl mx-auto text-center text-gray-600 mb-14"
...
//           className="p-10 space-y-8 bg-gray-300 shadow-lg rounded-xl md:p-14"
...
//               className="w-full px-5 py-4 text-sm transition bg-white border border-black rounded-md outline-none focus:ring-2 focus:ring-sky-400 focus:border-sky-400"
//             />
...
//             onChange={handleChange}
//             rows={5}
//             className="w-full px-5 py-4 text-sm transition border border-black rounded-md outline-none resize-none focus:ring-2 focus:ring-sky-400 focus:border-sky-400"
//           />
...
//               whileTap={{ scale: 0.95 }}
//               className="px-12 py-4 font-medium text-white transition-all duration-300 rounded-md shadow-md bg-sky-500 hover:bg-sky-600 hover:shadow-lg"
//             >
//               BOOK APPOINTMENT
//             </motion.button>
//           </div>
